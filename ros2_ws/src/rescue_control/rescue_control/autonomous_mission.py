...
# Keeps changes in velocity smooth.
...
class AutonomousMission(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            'AUTONOMOUS RESCUE MISSION STARTED'
        )
    ...
    def configure_search_motion(self):
        ...
        self.get_logger().info(
            'Configuring slow search motion'
        )
    ...
    def execute_centering(self):
        ...
        # -----------------------------------------------
        # Update filtered target position
        # -----------------------------------------------
        ...
        # -----------------------------------------------
        # Convert image error to ground error
        # -----------------------------------------------
        ...
        #
        # Never allow velocity to jump abruptly.
        # -----------------------------------------------
    ...
    def execute_descent(self):
        ...
        # Keep the aircraft over the centered target.
        ...
        # QR can be detected at ANY point during descent.
        # If confirmed, immediately send and RTL.
        ...
        # Only continue to QR_WAIT if we actually reach
        # the minimum search altitude.
    ...
    def image_callback(
        ...
        # QR is NOT used here.
        #
        # We first identify the white target, then center.
        # ==================================================

        if self.phase == 'SEARCH':

            if self.detect_white_target(
                frame
            ):
        ...
        if self.phase == 'CENTER':
            ...
            self.detect_white_target(
                frame
            )

            # QR is allowed to be visible here, but it is
            # NOT confirmed/used until descent.
    ...
    def mission_loop(self):
        ...
        if self.phase == 'QR_WAIT':
            ...
            # Hold centered position at minimum altitude.
